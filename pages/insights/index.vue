...
<template>
  <div>
    <PageHero eyebrow="Insights" title="Knowledge and insights." intro="Technical articles on languages, databases, serverless platforms and the awkward realities of keeping systems moving." gradient="violet" />
