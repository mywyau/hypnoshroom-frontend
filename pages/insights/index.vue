...
<template>
  <div>
    <PageHero eyebrow="Insights" title="Notes from the backend." intro="Short articles on languages, databases, serverless platforms and the awkward realities of keeping backend systems moving." />
