...
export const services: Service[] = [
  {
    ...
    shortDescription: 'Hands-on help to build, test, fix or deliver software.',
    whoFor: 'Teams with important software work to deliver and a gap in engineering capacity or specialist experience.',
    ...
    format: 'Delivered alongside an existing team or around a clearly defined piece of work, with priorities kept close to the agreed outcome.',
  },
  {
    id: 'technical-review',
    route: '/services',
